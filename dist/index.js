...
function getVehicleBoardings(query = {}, fields = [], orderBy2 = [], options = {}) {
  const db = options.db ?? openDb();
...
function getVehicleCategories(query = {}, fields = [], orderBy2 = [], options = {}) {
  const db = options.db ?? openDb();
...
function getVehicleCouplings(query = {}, fields = [], orderBy2 = [], options = {}) {
  const db = options.db ?? openDb();
